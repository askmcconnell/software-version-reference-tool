  ...
  return (
    <div style={{ maxWidth: 680, margin: '48px auto', padding: '0 16px 64px' }}>
      ...
      <p className="text-muted" style={{ fontSize: '0.9rem', marginBottom: 40 }}>
        Last updated April 2026 · SVRT is open source —{' '}
        <a
      ...
      <Section title="The short version">
        <p>
          SVRT never sees your actual hostnames, file contents, or personal data beyond
      ...
      <Section title="What your scanner collects">
        ...
        <BulletList items={[
          ...
          ['Software names, versions, vendors', 'Collected from installed applications. This is the core data SVRT needs to check EOL status.'],
      ...
      <Section title="What is stored on our servers">
        <p style={{ marginBottom: 12 }}>
          When you upload a CSV, SVRT stores on IONOS shared hosting (EU):
        </p>
        <BulletList items={[
      ...
      <Section title="The shared reference database">
        <p>
          ...
          This is what makes SVRT faster for everyone over time — a product researched for one
      ...
      <Section title="Third-party services">
        <BulletList items={[
          ...
          ['Stripe', 'Optional voluntary donations. SVRT never sees your payment details.'],
        ]} />
      </Section>

      <Section title="Cookies and tracking">
        <p>
          SVRT uses no analytics, no tracking pixels, no third-party cookies, and no advertising.
      ...
      <Section title="Questions">
        <p>
          ...
          Because SVRT is open source, you can also review exactly what the code does at any time.
        </p>
      </Section>
